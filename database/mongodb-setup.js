...
db.createCollection("trips", {
  validator: {
    $jsonSchema: {
      bsonType: "object",
      required: ["title", "destination", "startDate", "endDate", "ownerId", "createdAt", "updatedAt"],
      properties: {
...
db.trips.createIndex({ "destination": "text", "title": "text", "description": "text" });
...
print("Collections créées: users, trips, bookings, addresses, trip_invitations, notifications, trip_templates");
