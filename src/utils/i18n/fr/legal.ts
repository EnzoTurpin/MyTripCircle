const legal = {
  ...
  helpSupport: {
    ...
    faq1Answer: "Appuyez sur le bouton + dans l'onglet Mes voyages pour créer un nouveau voyage.",
    faq2Question: "Comment inviter des amis ?",
    faq2Answer: "Ouvrez un voyage, allez dans l'onglet Membres et appuyez sur 'Inviter des amis'.",
